...
import com.engiri.generadores.GeneredorNombres;
...
public class App01 {
    ...
    public static void main(String[] args) {
        try {
            ...
            insertarContactoBD(conexion, generarContactoAleatorio());
            mostrarDatosContactosBD(conexion);

            // descargarImagenesContactosBD(conexion);
            // cargarImagenesContactosBD(conexion, "./src/main/resources/imagenes/imgs");
    ...
    public static Contacto generarContactoAleatorio() {
        ...
        String correo = nombre.replaceAll(" ", "_").toLowerCase() + "@iessimarro.com";
        int telefono = new Random().nextInt(600000000, 700000000);
        String rutaImagen = "./src/main/resources/imagenes/default.jpg";
    ...
    public static void insertarContactoBD(Connection conex, Contacto contacto) {
        ...
        try {
            // Leemos la imagen y la convertimos en un array de bytes
            final byte[] binarioImagen = Files.readAllBytes(Paths.get(contacto.getImagen()));

            // preparamos el insert
            String queryInsert = "INSERT INTO contactos(nombre, correo, telefono, " +
                    "imagen, binarioImagen) VALUES (?,?,?,?,?)";
    ...
    public static void descargarImagenesContactosBD(Connection conex) throws SQLException, IOException {
        ...
        String querySelect = "SELECT imagen, binarioImagen FROM contactos";
        PreparedStatement queryFinalSelect = conex.prepareStatement(querySelect);
        ResultSet contactos = queryFinalSelect.executeQuery();
